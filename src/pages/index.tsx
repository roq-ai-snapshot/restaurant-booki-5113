  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of dining with Restaurant Booking Engine, a game-changing restaurant management app. Reserve tables, manage reservations, and explore menus, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of dining with Restaurant Booking Engine, a game-changing restaurant management app. Reserve tables, manage reservations, and explore menus, all in one place.`}
            </Text>
            <Box
